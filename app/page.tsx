  ...
  return (
    <div className="flex flex-col items-center gap-4">
      ...
      <p className="text-lg text-center max-w-2xl px-4 text-gray-400">
        The SMART framework help you set clear and achievable goals by being Specific, Measurable, Achievable, Relevant, and Time-bound. They make it easier to stay focuses and motivated while working towards your goals.
      </p>
