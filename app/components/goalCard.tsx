    ...
    return (
        <div className={`relative cursor-pointer px-5 py-3 text-center flex flex-col justify-center items-center h-40 w-80 ${colors[colorID]} rounded-3xl border-5 text-gray-300 transition-colors ease-in-out duration-300 overflow-hidden group`}>
            ...
            <div className="flex flex-row gap-1 absolute top-3 left-0 w-full justify-between px-3 opacity-0 group-hover:opacity-100 transition-opacity ease-in-out duration-300">
                <FontAwesomeIcon className="!size-5 text-red-400 bg-gray-800 p-1.5 rounded-lg hover:bg-gray-700 transition-colors ease-in-out duration-300" icon={faTrash}></FontAwesomeIcon>
                <div className="flex flex-row gap-1">
                    <FontAwesomeIcon className="!size-5 text-gray-400 bg-gray-800 p-1.5 rounded-lg hover:bg-gray-700 transition-colors ease-in-out duration-300" icon={faEdit}></FontAwesomeIcon>
                    <FontAwesomeIcon className="!size-5 text-green-400 bg-gray-800 p-1.5 rounded-lg hover:bg-gray-700 transition-colors ease-in-out duration-300" icon={faCheck}></FontAwesomeIcon>
                </div>
            </div>
