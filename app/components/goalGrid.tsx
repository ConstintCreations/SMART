    ...
    return (
        <div className="w-full flex flex-col items-center">
            ...
            <div className="flex flex-row flex-wrap gap-6 justify-center items-center">
                ...
                <Link href="./goals/create" className="cursor-pointer flex flex-col justify-center items-center h-40 w-40 bg-gray-800 hover:bg-gray-700 rounded-3xl border-5 border-gray-700 hover:border-gray-600 text-gray-400 hover:text-gray-300 transition-colors ease-in-out duration-300">
